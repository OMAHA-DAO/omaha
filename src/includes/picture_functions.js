...
module.exports = {
    ...
    // GSAP
    lazy_load_gsap_launch: function lazy_load_launch() {
        console.log("[LLGSAP] Launch");

        $('.LazyLoad[data-lazy-observing!="true"]').each(function() {
            let elem = $(this); // picture or img
            elem.data("lazy-load-observing", "true");
        ...
        //     let elem = $(this); // picture or img
        //     console.log("[LLGSAP]", elem);
        //
        //     gsap_single_process(elem);
        // });
    },
    gsap_single_process(elem){
        let parent = elem.parent();
